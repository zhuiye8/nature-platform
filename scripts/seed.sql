...
INSERT INTO iam_role_permission (role_code, permission_code) VALUES
    ...
    ('senior_assessor','customer:list'),('senior_assessor','contract:list'),('senior_assessor','project:list'),('senior_assessor','assessment:submit'),('senior_assessor','assessment:view'),('senior_assessor','assessment:start_qr'),('senior_assessor','report:list'),('senior_assessor','report:view'),('senior_assessor','archive:list'),('senior_assessor','archive:submit'),('senior_assessor','wf_task:view'),('senior_assessor','wf_task:operate'),
    ('middle_assessor','customer:list'),('middle_assessor','contract:list'),('middle_assessor','project:list'),('middle_assessor','assessment:submit'),('middle_assessor','assessment:view'),('middle_assessor','assessment:start_qr'),('middle_assessor','report:list'),('middle_assessor','report:view'),('middle_assessor','archive:list'),('middle_assessor','archive:submit'),('middle_assessor','wf_task:view'),('middle_assessor','wf_task:operate'),
    ('junior_assessor','customer:list'),('junior_assessor','contract:list'),('junior_assessor','project:list'),('junior_assessor','assessment:submit'),('junior_assessor','assessment:view'),('junior_assessor','report:list'),('junior_assessor','report:view'),('junior_assessor','wf_task:view'),('junior_assessor','wf_task:operate'),
...
INSERT INTO iam_role_resource (role_code, resource_key) VALUES
    ...
    ('senior_assessor','group.overview'),('senior_assessor','group.business'),('senior_assessor','page.workflow'),('senior_assessor','page.customers'),('senior_assessor','page.project-registers'),('senior_assessor','page.on-site-assessments'),
    ('middle_assessor','group.overview'),('middle_assessor','group.business'),('middle_assessor','page.workflow'),('middle_assessor','page.customers'),('middle_assessor','page.project-registers'),('middle_assessor','page.on-site-assessments'),
    ('junior_assessor','group.overview'),('junior_assessor','group.business'),('junior_assessor','page.workflow'),('junior_assessor','page.project-registers'),('junior_assessor','page.on-site-assessments'),
...
INSERT INTO wf_assignment_rule (node_key, slot_key, slot_label, role_code, avoidance_rule, priority) VALUES
    ...
    ('DEPT_REVIEW','REVIEWER','部门经理确认','dept_manager','NONE',10),('DEPT_REVIEW','REVIEWER','部门经理确认','super_admin','NONE',99),
    ('DIRECTOR_REVIEW','REVIEWER','项目主管审核','project_director','NONE',10),('DIRECTOR_REVIEW','REVIEWER','项目主管审核','super_admin','NONE',99),
