...
public class BuiltInPermissionRegistry {
  public List<BuiltInPermissionSpec> listAll() {
    return List.of(
        ...
        permission(AdminPermissionCodes.DEPARTMENT_MANAGE, "部门管理", "系统管理", "维护部门组织结构并配置数据范围"),
        permission(AdminPermissionCodes.DINGTALK_SYNC, "钉钉同步", "系统管理", "同步钉钉部门与用户数据"),
        ...
        permission(BusinessPermissionCodes.POLICE_REGISTER_SUBMIT, "公安登记提交", "业务流程", "提交公安登记流程"),
        ...
        permission(BusinessPermissionCodes.ON_SITE_ASSESSMENT_ASSIGN, "现场测评分配", "业务流程", "配置技术与内容审核分配"),
        permission(BusinessPermissionCodes.ON_SITE_ASSESSMENT_SUBMIT, "现场测评提交", "业务流程", "提交现场测评流程"),
        permission(BusinessPermissionCodes.ON_SITE_ASSESSMENT_CANDIDATE_VIEW, "现场测评候选池查看", "业务流程", "查看现场测评审核人候选池"),

        permission(BusinessPermissionCodes.REPORT_TECH_REVIEW_VIEW, "报告技术审核查看", "报告归档", "查看报告技术审核列表与详情"),
        permission(BusinessPermissionCodes.REPORT_TECH_REVIEW_CANDIDATE_VIEW, "报告技术审核候选池查看", "报告归档", "查看报告技术审核候选池"),
        permission(BusinessPermissionCodes.REPORT_TECH_REVIEW_SAVE, "报告技术审核保存", "报告归档", "保存报告技术审核结果"),
        ...
        permission(BusinessPermissionCodes.REPORT_COMPILE_ASSIGNMENT_CANDIDATE_VIEW, "编制分配候选池查看", "报告归档", "查看编制分配候选池"),
        ...
        permission(BusinessPermissionCodes.REPORT_FINAL_REVIEW_VIEW, "最终审核查看", "报告归档", "查看最终审核任务与详情"),
